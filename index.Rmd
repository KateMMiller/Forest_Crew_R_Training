...
This metric uses the joinRegenData() function to pull in the last 4 years of data, then uses group_by and summarize to generate a shapefile that has a row for every plot and a column for species, using codes. This time, we want to bring in all species, not just native and canopy species.

```{r newc1, echo=T, results='hide'}
RICH_regen_spp <- joinRegenData(park = "RICH", from = 2016, to = 2019)
