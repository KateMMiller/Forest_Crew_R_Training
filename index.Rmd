...
<details open><summary class='drop'>2. Tree diameter distribution figure <b style="color:red">Updated 7-6-20</b></summary>
...
tree_dist_plot <- ggplot(data = RICH_tree_dist_sum, aes(x = size_class, y = avg_dens))+
                         ...
                         theme(axis.text = element_text(size = 6), # change axis label size
                               ...
                               axis.title = element_text(size = 8), # change axis title size
...
```{r, m10_7, echo=T, results = 'hide', messages='hide', warning = FALSE}
...
```{r m11_1, echo = T, results = 'hide', message = 'hide', warning = FALSE}
...
```{r m12_4, echo=T, results = 'hide', warning = FALSE}
...
```{r m14_2, results = 'hide', echo = TRUE, warning=FALSE}
