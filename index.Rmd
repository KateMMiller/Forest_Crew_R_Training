...
<details open><summary class='drop'>12. Invasive cover by cycle</summary>
...
<details open><summary class='drop'>14. Invasive cover by species <b style="color:red">Updated 7-15-20</b></summary>
...
<b style="color:red">Updated code chunk (see GETT_inv_pie2) 7-15-20</b>
```{r m14_2, results = 'hide', echo=TRUE}
inv_herb <- data.frame(sppcode = c("DUCIND", "PERLON", "ALLPET"))
inv_woody <- data.frame(sppcode = c("DIOOPP", "CELORB", "EUOALA", "ELAANG", "ELASPP", "ELAUMB", "LONSPP"))

GETT_inv_pie <- GETT_inv_pie %>% mutate(sppgrp = case_when(sppcode %in% inv_herb$sppcode ~ paste0("INVHERB"),
...
<details open><summary class='drop'>15. Invasive species plot frequency <b style="color:red">Updated 7-8-20</b></summary>
...
```
The easiest way to bind the plot number and invasive list together is to make the RICH_plot_nums have the same column names as RICH_invlist2, then to bind the rowse (rbind) together.
