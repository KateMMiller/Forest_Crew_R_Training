...
```
<details open><summary class='drop'>10. Regeneration by composition  <b style="color:red">Updated 7-8-20</b></summary>
...
RICH_loc_ev <- joinRegenData(park = "RICH", from = 2016, to = 2019) %>% select(Plot_Name, Plot_Number, X_Coord, Y_Coord)

intersect(names(RICH_loc_ev), names(RICH_reg_wide))
