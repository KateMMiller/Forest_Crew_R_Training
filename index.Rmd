...
exo_herb <- data.frame(sppcode = c("DUCIND", "GLEHED", "PERLON", "VINMIN")) #added 7/22
...
<details open><summary class='drop'>15. Invasive species plot frequency <b style="color:red">Updated 7-22-20</b></summary>
...
inv_list <- read.csv("../data/Invasive_List.csv")
MIDN_inv_list <- inv_list %>% filter(MIDN_INV == 1) %>% select(Latin_Name, Year_added) 
...
RICH_inv_spplist2 <- merge(MIDN_inv_list, 
...
<b style="color:red">Updated code chunk 7-22-20</b>
```{r m_15_4, echo=TRUE, results = 'hide', warning=FALSE, message = FALSE, comment = FALSE}
exospp_list <- c("Duchesnia indica", "Glechoma hederacea", "Persicaria longiseta", "Vinca minor")
